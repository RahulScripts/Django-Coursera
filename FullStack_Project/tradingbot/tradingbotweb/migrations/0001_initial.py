    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desatination_currency_value', models.DecimalField(decimal_places=2, max_digits=10)),
                ('commission', models.DecimalField(decimal_places=2, default=1.0, max_digits=10)),
